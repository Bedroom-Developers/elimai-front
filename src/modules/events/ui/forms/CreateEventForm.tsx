...
import { Popover, PopoverContent, PopoverPositioner, PopoverTrigger } from "@/shared/components/ui/popover";
            ...
            <Controller
                ...
                render={({ field: { value, onChange }, formState: { errors } }) => (
                    <FormField label="Дата" name="event_date" error={errors.event_date?.message}>
                        <Popover>
                            <PopoverTrigger render={(props) => <Button variant={'outline'} className={'justify-start'} {...props}>
