...
export const PurchaseSuccessView = ({ tickets }: PurchaseSuccessViewProps) => {
    ...
    return (
        <div className="flex flex-col gap-4 p-4 sm:p-6">
            <div className="flex gap-3 rounded-lg border border-emerald-200 bg-emerald-50 p-4 text-sm text-emerald-900 dark:border-emerald-900/40 dark:bg-emerald-950 dark:text-emerald-100">
                <BadgeCheck className="mt-0.5 h-5 w-5 shrink-0 text-emerald-500" />
                <div className="space-y-1">
                    <p className="font-semibold">
                        {t("result.success.sub.message")}
                    </p>
